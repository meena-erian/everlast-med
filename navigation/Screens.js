...
function DoctorsStack(props) {
  return (
    <Stack.Navigator initialRouteName="Doctors" mode="card" headerMode="screen">
      <Stack.Screen
        name="Doctors"
...
function TermsStack(props) {
  return (
    <Stack.Navigator initialRouteName="Terms" mode="card" headerMode="screen">
      <Stack.Screen
        name="Terms"
...
function AppStack(props) {
  return (
    ...
    >
      <Drawer.Screen name="Explore Treatments" component={HomeStack} />
      <Drawer.Screen
        name="Reservation"
