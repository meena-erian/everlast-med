        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              <Block > 
                <Block>
                  <Text color="white" size={40}>Application</Text>
                </Block>
                <Block>
                  <Text color="white" size={40}>Under</Text>
                </Block>
                <Block row>
                  <Text color="white" size={40}>Development</Text>
                </Block>
              </Block>
              <Text size={16} color='rgba(255,255,255,0.6)'>
                Sorry for inconvenience! This section of the app is not done yet.
                {/*Current Rout Parameters: {JSON.stringify(route.params, null, 2)}*/}
              </Text>
