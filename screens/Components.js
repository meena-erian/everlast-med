...
import { materialTheme, services, Images } from '../constants/';
  ...
  renderCards = () => {
    return (
      <Block flex style={styles.group}>
        ...
        <Block flex>
          <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
            <Product product={services[0]} horizontal />
            <Block flex row>
              <Product product={services[1]} style={{ marginRight: theme.SIZES.BASE }} />
              <Product product={services[2]} />
            </Block>
            <Product product={services[3]} horizontal />
            <Product product={services[4]} full />
            <Block flex card shadow style={styles.category}>
              <ImageBackground
                source={{ uri: Images.services['Accessories'] }}
