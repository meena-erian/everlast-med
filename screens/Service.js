...
export default class Service extends React.Component {
  ...
  render() {
    ...
    let relatedServices = services.filter(
      (product) => product.category == route.params.category && product.title !== route.params.title
    );
    return (
      <Block flex center style={styles.home}>
        ...
        >
          <Block style={styles.mainBlock} autoFocus={true}>
            <Image
              source={{ uri: (route.params.image ? route.params.image : Images.Profile) }}
          ...
          <Text h4 style={styles.related}>Related Services</Text>
          <Block flex>
